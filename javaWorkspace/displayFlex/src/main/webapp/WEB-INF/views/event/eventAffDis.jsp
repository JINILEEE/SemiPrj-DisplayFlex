    ...
    <div class="bw"> 
        ...
        <div id="main_content">
            <a style=text-decoration:none; href="/cinema/event/eventdetail"><div class="content_area">
                <h1>이벤트 게시글1</h1>
                <div>
                    <div class="content_title" >제휴/할인 게시글1</div>
            ...
            <div class="content_area">
                <h1>이벤트 게시글 사진2</h1>
                <div>
                    <div class="content_title">제휴/할인 게시글2</div>
            ...
            <div class="content_area">
                <h1>이벤트 게시글 사진3</h1>
                <div>
                    <div class="content_title">제휴/할인 게시글3</div>
            ...
            <div class="content_area">
                <h1>이벤트 게시글 사진4</h1>
                <div>
                    <div class="content_title">제휴/할인 게시글4</div>
